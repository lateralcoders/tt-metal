...
run_perf_models_cnn_javelin() {
    ...
    env WH_ARCH_YAML=wormhole_b0_80_arch_eth_dispatch.yaml HF_HOME=/mnt/MLPerf/tt_dnn-models/StableDiffusion pytest -n auto models/demos/wormhole/stable_diffusion/tests -m $test_marker --timeout=480
