...
void MAIN {
    ...
    constexpr uint32_t two = 0x40000000u;    // Represents 2.0f
    constexpr uint32_t limit = 0x40600000u;  // Represents 3.5f
    ...
    for (uint32_t block_index = 0; block_index < per_core_block_cnt; block_index++) {
        ...
        for (uint32_t tile_index = 0; tile_index < per_core_block_dim; ++tile_index) {
            ...
            tile_regs_release();
            // DPRINT << "Test c3" << ENDL();
            // DPRINT << TSLICE(tt::CBIndex::c_3, 0, SliceRange::hw0_32_16()) << ENDL();
            ...
            tile_regs_release();
            // DPRINT << "Test c8" << ENDL();
            // DPRINT << TSLICE(tt::CBIndex::c_8, 0, SliceRange::hw0_32_16()) << ENDL();
            ...
            tile_regs_release();
            // DPRINT << "Test c2" << ENDL();
            // DPRINT << TSLICE(tt::CBIndex::c_2, 0, SliceRange::hw0_32_16()) << ENDL();
            cb_push_back(cb_output, 1);
